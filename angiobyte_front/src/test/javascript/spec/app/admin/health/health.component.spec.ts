...
import { AngiobyteTestModule } from '../../../test.module';
import { AgbHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { AgbHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('AgbHealthCheckComponent', () => {

        let comp: AgbHealthCheckComponent;
        let fixture: ComponentFixture<AgbHealthCheckComponent>;
        let service: AgbHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AngiobyteTestModule],
                declarations: [AgbHealthCheckComponent],
                providers: [
                    AgbHealthService,
                    {
                        provide: NgbModal,
            ...
            }).overrideTemplate(AgbHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(AgbHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(AgbHealthService);
        });
